...
versioning_bucket_name = "mfe-versioning-d10"
...
microfrontends = [
  {
    ...
    host_name       = "ohpd10-authconfig",
    allowed_origins = [
      "https://ohpd10-host.dev.davincicloud.nl"
    ]
  },
  {
    service_name    = "mfe-processconfig",
    host_name       = "ohpd10-processconfig",
    allowed_origins = [
      "https://ohpd10-host.dev.davincicloud.nl"
    ]
  },
  ...
  },
  {
  ...
  },
   {
    ...
    host_name       = "ohpd10-productconfig",
    allowed_origins = [
      "https://ohpd10-host.dev.davincicloud.nl"
    ]
  },
  {
    ...
    host_name       = "ohpd10-financialconfigservice",
    allowed_origins = [
      "https://ohpd10-host.dev.davincicloud.nl"
    ]
  },
  {
    ...
    host_name       = "ohpd10-appinstanceconfig",
    allowed_origins = [
      "https://ohpd10-host.dev.davincicloud.nl"
    ]
  },
  {
    ...
    host_name       = "ohpd10-accountingconfig",
    allowed_origins = [
      "https://ohpd10-host.dev.davincicloud.nl"
    ]
  },
  {
    ...
    host_name       = "ohpd10-taxstatementconfig",
    allowed_origins = [
      "https://ohpd10-host.dev.davincicloud.nl"
    ]
  },
   {
    ...
    host_name       = "ohpd10-runningaccountconfigservice",
    allowed_origins = [
      "https://ohpd10-host.dev.davincicloud.nl"
    ]
  },

  {
    ...
    host_name       = "ohpd10-communicationconfigservice",
    allowed_origins = [
      "https://ohpd10-host.dev.davincicloud.nl"
    ]
  },
  {
    ...
    host_name       = "ohpd10-collectionmeasureconfig",
    allowed_origins = [
      "https://ohpd10-host.dev.davincicloud.nl"
    ]
  },

...
// @ts-ignore
import { AssignPermissionRequest2 } from '../model/assignPermissionRequest2';
// @ts-ignore
...
export class PortalUserService {
     ...
     * @param assignPermissionRequest2 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public portalUserPutIntermediaryAssignPermission(intermediaryId: string, assignPermissionRequest2: AssignPermissionRequest2, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any>;
    public portalUserPutIntermediaryAssignPermission(intermediaryId: string, assignPermissionRequest2: AssignPermissionRequest2, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<any>>;
    public portalUserPutIntermediaryAssignPermission(intermediaryId: string, assignPermissionRequest2: AssignPermissionRequest2, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<any>>;
    public portalUserPutIntermediaryAssignPermission(intermediaryId: string, assignPermissionRequest2: AssignPermissionRequest2, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        if (assignPermissionRequest2 === null || assignPermissionRequest2 === undefined) {
            throw new Error('Required parameter assignPermissionRequest2 was null or undefined when calling portalUserPutIntermediaryAssignPermission.');
        }

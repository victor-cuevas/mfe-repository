...
export class GetFollowUpCaseStatusDunningDossierStatusResolver implements Resolve<boolean> {
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> {
    return this.followupDunningService.getFollowUpCaseStatusDunningDossierStatus().pipe(
      catchError((error) => {

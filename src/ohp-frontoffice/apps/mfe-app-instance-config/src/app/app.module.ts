...
@NgModule({
  ...
  imports: [BrowserModule, HttpClientModule, RouterModule.forRoot(APP_ROUTES, { initialNavigation: 'enabledNonBlocking' }), BrowserAnimationsModule, ProgressSpinnerModule,
  SharedConfigModule, AmplifyAuthenticatorModule],
  providers: [{

...
import { ACCOUNTING_CONFIG_ROUTES } from './accounting-config-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forChild(ACCOUNTING_CONFIG_ROUTES),
    SharedI18nModule.forRoot({ path: '/assets/i18n/Accounting-Config/', mfeName: 'accounting' })
  ],
  providers: [
    {

...
import { ASSET_CONFIG_ROUTES } from './asset-config-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forChild(ASSET_CONFIG_ROUTES),
    SharedI18nModule.forRoot({ path: '/assets/i18n/Asset-Config/', mfeName: 'asset' })
  ],
  providers: [
    {

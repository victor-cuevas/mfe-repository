...
module.exports = {
  output: {
    uniqueName: 'mfeCollectionMeasureConfig',
    publicPath: 'auto'
  },
  optimization: {
    runtimeChunk: false
  ...
  plugins: [
    new ModuleFederationPlugin({
      name: 'mfeCollectionMeasureConfig',
      filename: 'remoteEntry.js',
      exposes: {
        './Module': './apps/mfe-collection-measure-config/src/app/collection-measure-config/collection-measure-config.module.ts'
      },
      library: { type: 'module' },
      shared: share({

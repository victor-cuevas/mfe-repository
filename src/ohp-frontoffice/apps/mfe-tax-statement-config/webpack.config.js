...
module.exports = {
  output: {
    uniqueName: 'mfeTaxStatementConfig',
    publicPath: 'auto'
  },
  optimization: {
    runtimeChunk: false
  ...
  plugins: [
    new ModuleFederationPlugin({
      name: 'mfeTaxStatementConfig',
      filename: 'remoteEntry.js',
      exposes: {
        './Module': './apps/mfe-tax-statement-config/src/app/tax-statement-config/tax-statement-config.module.ts'
      },
      library: { type: 'module' },
      shared: share({

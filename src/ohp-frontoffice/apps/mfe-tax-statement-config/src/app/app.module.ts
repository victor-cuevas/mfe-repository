...
@NgModule({
  ...
  imports: [BrowserModule, HttpClientModule, RouterModule.forRoot(APP_ROUTES, { initialNavigation: 'enabledNonBlocking' }),ProgressSpinnerModule,SharedConfigModule,AmplifyAuthenticatorModule,BrowserAnimationsModule],

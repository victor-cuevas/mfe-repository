...
import { PLAN_CONFIG_ROUTES } from './plan-config-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forChild(PLAN_CONFIG_ROUTES),
    SharedI18nModule.forRoot({ path: '/assets/i18n/plan-config/', mfeName: 'plan' })

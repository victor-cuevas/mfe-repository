...
module.exports = {
  output: {
    uniqueName: 'mfeFinancialConfigService',
    publicPath: 'auto'
  },
  optimization: {
    runtimeChunk: false
  ...
  plugins: [
    new ModuleFederationPlugin({
      name: 'mfeFinancialConfigService',
      filename: 'remoteEntry.js',
      exposes: {
        './Module': './apps/mfe-financial-config-service/src/app/financial-config-service/financial-config-service.module.ts'
      },
      library: { type: 'module' },
      shared: share({

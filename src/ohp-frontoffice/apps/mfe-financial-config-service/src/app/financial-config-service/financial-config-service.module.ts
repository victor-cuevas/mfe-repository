...
import { FINANCIAL_CONFIG_SERVICE_ROUTES } from './financial-config-service-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forChild(FINANCIAL_CONFIG_SERVICE_ROUTES),
    SharedI18nModule.forRoot({ path: '/assets/i18n/Financial-Config-Service/' , mfeName: 'financial' })],
    providers: [
      {
...
export class FinancialConfigServiceModule {

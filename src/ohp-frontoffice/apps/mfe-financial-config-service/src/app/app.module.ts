...
@NgModule({
  ...
  imports: [BrowserModule, RouterModule.forRoot(APP_ROUTES, { initialNavigation: 'enabledNonBlocking' }),ProgressSpinnerModule, HttpClientModule, BrowserAnimationsModule,SharedConfigModule, AmplifyAuthenticatorModule],
  providers: [
    {

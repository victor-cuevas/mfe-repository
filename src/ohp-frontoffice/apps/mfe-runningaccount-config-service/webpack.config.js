...
module.exports = {
  output: {
    uniqueName: 'mfeRunningAccountConfigService',
    publicPath: 'auto'
  },
  optimization: {
    runtimeChunk: false
  ...
  plugins: [
    new ModuleFederationPlugin({
      name: 'mfeRunningAccountConfigService',
      filename: 'remoteEntry.js',
      exposes: {
        './Module': './apps/mfe-runningaccount-config-service/src/app/runningaccount-config-service/runningaccount-config-service.module.ts'
      },
      library: { type: 'module' },
      shared: share({

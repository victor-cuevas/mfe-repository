...
import { RUNNINGACCOUNT_CONFIG_ROUTES } from './runningaccount-config-service-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forChild(RUNNINGACCOUNT_CONFIG_ROUTES),
    SharedI18nModule.forRoot({ path: '/assets/i18n/runningaccount-config/', mfeName: 'runningaccount' })
  ],
  providers: [
    {
...
export class RunningaccountConfigServiceModule {
